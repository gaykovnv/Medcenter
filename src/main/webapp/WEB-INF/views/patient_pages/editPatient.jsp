                ...
                <form:form action="savePatient" method="post" modelAttribute="patient">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td scope="col"><form:input path="telephone"/></td>
                        </tr>
                        <tr>
                            <td><input class="btn btn-outline-primary my-2" type="submit" value="Save"></td>
                            <td><a class="btn btn-outline-primary my-2" href="patient">Back</a></td>
                        </tr>
                    </table>
                </form:form>
